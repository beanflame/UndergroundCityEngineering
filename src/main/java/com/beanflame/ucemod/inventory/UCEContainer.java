package com.beanflame.ucemod.inventory;
...
public class UCEContainer extends Container
{
    ...
    public int cookTime;
    public UCEContainer(EntityPlayer player, EntityEngineerWorktable tileEntityBclogxz, int AbenginX, int AbeginY, int BbeginX, int BbeginY)
    {
    ...
    public UCEContainer(EntityPlayer player, EntityEngineerWorktable tileEntity)
    {
